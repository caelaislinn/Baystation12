...
/decl/hierarchy/supply_pack/khoros/lightarmour
	...
	contains = list(/obj/item/clothing/shoes/innie_boots/light/green = 1,\
		/obj/item/clothing/head/helmet/innie/light/green = 1,\
		/obj/item/clothing/suit/storage/innie/light/green = 1)
	cost = 1250
...
/decl/hierarchy/supply_pack/khoros/mediumarmour
	...
	contains = list(/obj/item/clothing/shoes/innie_boots/medium/green = 1,\
		/obj/item/clothing/head/helmet/innie/heavy/green = 1,\
		/obj/item/clothing/suit/storage/innie/medium/green = 1)
	cost = 1500
...
/decl/hierarchy/supply_pack/khoros/heavyarmour
	...
	contains = list(/obj/item/clothing/shoes/innie_boots/medium/green = 1,\
		/obj/item/clothing/head/helmet/innie/heavy/green = 1,\
		/obj/item/clothing/suit/storage/innie/heavy/green = 1)
	cost = 1500
