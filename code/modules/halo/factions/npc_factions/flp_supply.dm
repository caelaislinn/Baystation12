...
/decl/hierarchy/supply_pack/flp/lightarmour
	...
	contains = list(/obj/item/clothing/shoes/innie_boots/light/blue = 1,\
		/obj/item/clothing/head/helmet/innie/light/blue = 1,\
		/obj/item/clothing/suit/storage/innie/light/blue = 1)
	cost = 1250
...
/decl/hierarchy/supply_pack/flp/mediumarmour
	...
	contains = list(/obj/item/clothing/shoes/innie_boots/medium/blue = 1,\
		/obj/item/clothing/head/helmet/innie/heavy/blue = 1,\
		/obj/item/clothing/suit/storage/innie/medium/blue = 1)
	cost = 1500
...
/decl/hierarchy/supply_pack/flp/heavyarmour
	...
	contains = list(/obj/item/clothing/shoes/innie_boots/medium/blue = 1,\
		/obj/item/clothing/head/helmet/innie/heavy/blue = 1,\
		/obj/item/clothing/suit/storage/innie/heavy/blue = 1)
	cost = 1500
