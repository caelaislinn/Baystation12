...
/datum/faction/insurrection
	...
	defender_mob_types = list(/mob/living/simple_animal/hostile/innie = 3, /mob/living/simple_animal/hostile/innie/medium = 2, /mob/living/simple_animal/hostile/innie/heavy = 1)
