...
/obj/item/clothing/under/covenant/ranger_kigyar
	...
	sprite_sheets = list("Kig-Yar" = 'code/modules/halo/covenant/species/kigyar/ranger_kigyar.dmi',"Tvaoan Kig-Yar" = 'code/modules/halo/covenant/species/kigyar/ranger_kigyar.dmi')
